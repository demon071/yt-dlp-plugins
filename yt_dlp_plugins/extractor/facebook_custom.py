        ...
        if not video_data:
            ...
            if data:
                ...
                def parse_attachment(attachment, key='media'):
                    ...
                    playback_video = attachment.get('playback_video') or None
                    if playback_video:
                        return parse_graphql_video(playback_video)
                ...
                if video:
                    attachments = try_get(video, [
                        ...
                        lambda x: x['creation_story']['short_form_video_context'],
                    ], list) or []
                    for attachment in attachments:
                        parse_attachment(attachment)
                    if not entries:
